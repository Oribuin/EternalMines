...
//     */
//    public void load() {
//        File menuFile = MineUtils.createFile(this.rosePlugin, "menus", this.getMenuName() + ".yml");
...
//        return Component.text(MineUtils.format(player, text));
//    }
//
//    /**
//     * Format a string with placeholders and color codes
...
//        return Component.text(MineUtils.format(player, text, placeholders));
//    }
//
//    /**
//     * Format a string with placeholders and color codes
...
//        return MineUtils.format(player, text);
//    }
//
//    /**
//     * Format a string with placeholders and color codes
...
//        return MineUtils.format(player, text, placeholders);
//    }
//
//    /**
